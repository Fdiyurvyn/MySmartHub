...
<head>
    ...
    <style>
        ...
        .ai-heading { padding: 1.5rem; border-bottom: 1px solid var(--border-color); }
        ...
        .ai-message { max-width: 78%; padding: .85rem 1rem; border-radius: 14px; white-space: pre-wrap; overflow-wrap: anywhere; }
...
<body>
    ...
    <main class="ai-shell"><div class="ai-card">
        <header class="ai-heading"><h1>✨ SmartHub Assistant</h1><p>Asisten produktivitas untuk tugas, jadwal, dan keuangan Anda.</p></header>
